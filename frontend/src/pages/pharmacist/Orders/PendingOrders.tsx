...
import p1 from "../../../assets/images/Products/Cold and Flu Medicine.jpeg";
...
const Orders = [
    { id: 1, items: 1, product: "Cold & Flu", price: 330, photo: p1 },
    { id: 2, items: 1, product: "Digital Thermometer", price: 730, photo: p2 },
        ...
        if (Orders) {
            setRows(
                Orders.map((i) => ({
                    ...
                    price: i.price,
                    action: (
                        <div className=' p-2 text-orange-500'>Pending</div>
                    ),
                }))
            );
        }
